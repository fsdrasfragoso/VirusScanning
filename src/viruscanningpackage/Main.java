...
public class Main {
	...
	public static void main(String[] args) {
		...
		int tamanho = 1258;
                ...
                Componente_02_VirusSignaturesCreator signatures = new Componente_02_VirusSignaturesCreator(CaminhoSignature,tamanho);
	    Componente_03_VirusScanningServer virusScanner = new Componente_03_VirusScanningServer(signatures.getSignatureDB(),CaminhoScarnning,tamanho);
